...
-- --------------------------------------------------
-- Date Created: 05/04/2016 16:04:46
...
IF OBJECT_ID(N'[dbo].[FK_DataChlorine]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[DataSet] DROP CONSTRAINT [FK_DataChlorine];
GO
IF OBJECT_ID(N'[dbo].[FK_DatapH]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[DataSet] DROP CONSTRAINT [FK_DatapH];
GO
IF OBJECT_ID(N'[dbo].[FK_DataTemperature]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[DataSet] DROP CONSTRAINT [FK_DataTemperature];
GO
IF OBJECT_ID(N'[dbo].[FK_DataHumidity]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[DataSet] DROP CONSTRAINT [FK_DataHumidity];
GO

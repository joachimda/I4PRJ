...
Den visuelle Implementering af websitet med ASP.NET MVC er skrevet i HTML og CSS. Clientside funktionaliteten er skrevet i JavaScript. Slutteligt er der brugt razor, som er et server-side markup sprog\todo{reference mangler}. StatView ses figur~\ref{fig:webstatview}.

...
\newglossaryentry{dotcover}{
	name={DotCover}, 
	description={Lavet af JetBrains. dotCover er et .NET test-runner og code coverage værktøj}
}
...
\newglossaryentry{nunit}{
	name={NUnit},
	description={Unittest framework til .NET }
}

\newglossaryentry{nsub}{
	name={NSubstitute},
	description={Mocking framework til .NET }
}

...
\begin{figure}
\centering
\includegraphics[width=0.7\linewidth]{figs/dbSeq/createDataEntry}
...
På figur~\ ses sekvensdiagrammet for GetChlorine data. Måden hvorpå dette udføres er den samme for alle fire typer af data.

\begin{figure}
\centering
\includegraphics[width=0.7\linewidth]{figs/dbSeq/getChlorineData}

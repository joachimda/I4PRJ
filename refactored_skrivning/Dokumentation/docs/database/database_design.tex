\section{Indledende design overvejelser}
...
\section{Persistering af sensordata}
...
\subsection{User Story - Se pooldata}
...
\section{Endeligt database og DAL design}

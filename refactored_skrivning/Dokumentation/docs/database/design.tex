...
Fra starten har det været klart at systemet skulle udvikles i flere faser. I løbet af disse er Databasen og data access laget derfor udviklet sideløbende med resten af systemets funktionalitet.

...
\caption{Visual Studio's Entity Model Designer}
...
Det første \textit{Model first} udkast til projektets database var meget omfattende og er sidenhen blevet revideret og omkonstrueret. Se figur~\ref{fig:databaseERD_firstattempt_uml} for dette tidlige design.

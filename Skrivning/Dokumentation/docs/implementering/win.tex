...
\begin{lstlisting}[caption=Caption til kodebid,label=code:asd]
...
\begin{lstlisting}[caption=Caption til kodebid, label=asd2]
...
\begin{lstlisting}[caption=bla bla bla, label=code:asd3]
<!-- StatView template -->

...
\section{Test}
Sidste led i udviklingen af en del-feature er test. Det gælder for alle lag af projektet, dog adskiller måden at teste sig i de forskellige lag. GUI blev testet ved en kvalitativ visuel user experience test\todo{Er det at tage munden lidt for fuld?}. Til Business logikken er klassernes metoder unit testet. Til det anvendes et automatiseret test framework Nunit, som fungerer som dokumentation af koden dvs. ændres noget i koden og testen stadig går godt, antages ændringen at være korrekt. Hvad med database??
...
For at holde styr på branches og versioner er der brugt Feature Branching \cite{atlassian2016}. Dette indebære der ikke foregår noget produktionsarbejde på master branchen. I stedet skal der oprettes en branch specielt til denne feature. Så når denne feature er testet med seneste udgave af master branchen, kan ændringerne blive ''merget''\todo{Det danske ord er flette} ind. På denne måde har gruppen hele tiden haft en fungerende produkt at vise frem, hvis det skulle blive nødvendigt.
...
\subsection{Travis CI og Jenkins} \todo{Hele afsnittet er meget rodet, og det er usikkert hvad der prøves at fortælle. Resultatet skal udpensles og refleksioner herpå. Brugte vi det? Til hvad brugte vi det? Hvorfor brugte vi det ikke mere? Vi skal ikke forklare, hvordan CI fungerer men om vi har brugt det og hvad vi har fået ud af det.}
Gruppen har undervejs forsøgts sig med både med Travis CI og Jenkins. Da gruppen allerede var godt bekendt med Jenkins, virkede Travis CI som en interessant mulighed for at prøve noget anderledes. \todo{Arg, det må være en bedre årsag}
...
Det har dog ikke forhindret et forsøg. Det lykkedes gruppen at sætte den ellers kun ''community supported'' Travis CI op til at teste et C\# projekt fra github, som skulle konstatere om der skulle bruges mere tid på Travis CI. \todo{Og hvad så... Hvad var konklusionen?}
